...
public class CartController {
	...
	public ResponseEntity<String> deleteProductById(@PathVariable int eid) {
	...
	public ResponseEntity<CartP> getCartById(@PathVariable int cartId) throws Throwable {

		return new ResponseEntity<CartP>(cartservice.getCartById(cartId), HttpStatus.OK);
	}

	@DeleteMapping(path = "/deleteCartById/{cartId}")
	public ResponseEntity<String> deleteSeedById(@PathVariable int cartId) {
	...
	public ResponseEntity<CartP> updateCart(@RequestBody CartP e) throws Throwable {
		CartP e1 = cartservice.updateCart(e);
		ResponseEntity re = new ResponseEntity<CartP>(e1, HttpStatus.OK);
		return re;
	}

	@GetMapping("/bill/{cartId}")
	public ResponseEntity<String> getBillById(@PathVariable int  cartId) {
		String b =cartservice.getBillById(cartId);
		ResponseEntity re = new ResponseEntity<String>(b, HttpStatus.OK);
		return re;
	}
